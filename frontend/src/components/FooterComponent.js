        ...
        <div className='footer'>
            <div className='row justify-content-center m-0 text-center'>
                <div className='col-md-3 offset-md-1 col-12'>
                    ...
                    <a className='btn btn-social-icon btn-facebook' href='https://www.facebook.com/alokaakash.me.0101'><i className='fa fa-user-circle fa-lg'></i></a>                    
                    <a className='btn btn-social-icon btn-linkedin' href='https://www.linkedin.com/in/07alokkumar'><i className='fa fa-linkedin fa-lg'></i></a>
                    <a className='btn btn-social-icon btn-github' href='https://github.com/Alok4k45h'><i className='fa fa-github fa-lg'></i></a>
                    <br /> <br/>
                </div>
